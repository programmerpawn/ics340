...
public class DelivA {
	...
	private void runDelivA() {
		...
		Collections.sort(graph.getNodeList(), new NodeCompareSizeIn()); //order from biggest to smallest for ingoing edges
		...
		Collections.sort(graph.getNodeList(), new NodeCompareSizeOut()); //order from biggest to smallest for outgoing edges
